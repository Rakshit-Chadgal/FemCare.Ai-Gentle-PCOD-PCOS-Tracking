...
export default function Home() {
  ...
  return (
    <div className="pt-6 pb-4 space-y-5">
      ...
      <div className="glass-card rounded-2xl p-5 flex items-center gap-4 animate-card-rise" style={{ animationDelay: '50ms' }}>
      ...
      {logs.length === 0 ? (
        <div className="glass-card rounded-2xl p-6 text-center animate-card-rise" style={{ animationDelay: '150ms' }}>
        ...
        <>
          ...
          {insight ? (
            ...
            <Link to="/insights" className="block glass-card rounded-2xl p-5 hover:shadow-md transition animate-card-rise" style={{ animationDelay: '250ms' }}>
